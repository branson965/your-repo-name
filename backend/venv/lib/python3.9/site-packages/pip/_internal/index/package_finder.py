...
def filter_unallowed_hashes(
    candidates: list[InstallationCandidate], hashes: Hashes | None, project_name: str,
...
class CandidateEvaluator:
    ...
    def get_applicable_candidates(
        ...
        versions = set(
            specifier.filter(
                (v for _, v in candidates_and_versions), prereleases=allow_prereleases,
            )
        )
...
class PackageFinder:
    ...
    def find_requirement(
        ...
        best_candidate_result = self.find_best_candidate(
            name, specifier=req.specifier, hashes=hashes,
        )
