...
class Resolution(Generic[RT, CT, KT]):
    ...
    def _add_to_criteria(
        self, criteria: dict[KT, Criterion[RT, CT]], requirement: RT, parent: CT | None,
    ) -> None:
    ...
    def _patch_criteria(
        ...
        for k, incompatibilities in incompatibilities_from_broken:
            ...
            matches = self._p.find_matches(
                identifier=k,
                requirements=IteratorMapping(
                    self.state.criteria, operator.methodcaller("iter_requirement"),
                ),
                incompatibilities=IteratorMapping(
                    self.state.criteria,
                    operator.attrgetter("incompatibilities"),
    ...
    def resolve(self, requirements: Iterable[RT], max_rounds: int) -> State[RT, CT, KT]:
        ...
        self._states = [
            State(mapping=collections.OrderedDict(), criteria={}, backtrack_causes=[],)
        ]
